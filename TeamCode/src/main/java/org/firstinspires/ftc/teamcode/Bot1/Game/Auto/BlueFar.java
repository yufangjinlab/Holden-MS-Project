...
@Autonomous(name="BlueFar", group="BlueAuto")
//@Disabled
public class BlueFar extends LinearOpMode {
    ...
    private int LAUNCH_VELOCITY_AUTO_FAR = (int) (3650 * 28)/60;
    private int MAX_LAUNCH_VELOCITY_AUTO_FAR= LAUNCH_VELOCITY_AUTO_FAR +45;
    private int MIN_LAUNCH_VELOCITY_AUTO_FAR = LAUNCH_VELOCITY_AUTO_FAR;
    ...
    private double yIniPositionRed = 82.2;
...
//            /************* The turret keeps changing. NOT A GOOD Way for AUTO**************/
            ...
            switch (finiteState) {
                ...
                case DRIVING_TO_LAUNCH_POSE:
                    if (autoDrivingTimer.milliseconds() <723) {
                        moveForward();
                        mecanumDrive();
                ...
                case SPIN:
                    //delivery.updateRPM(delivery.updateDistance(currentPose, "RED"));
                    delivery.launcher.setVelocity(LAUNCH_VELOCITY_AUTO_FAR);
                    if ((MAX_LAUNCH_VELOCITY_AUTO_FAR > delivery.launcher.getVelocity()) && (delivery.launcher.getVelocity() > MIN_LAUNCH_VELOCITY_AUTO_FAR)) {
                        VELOCITY_CHECK += 1;
                        if (VELOCITY_CHECK == 1) {
                            PIDTimer.reset();
                        }
                ...
                case DRIVING_AWAY_FROM_LAUNCH:
                    ...
                    delivery.launcher.setPower(0);
                    turret.turret.setPower(0);
                    if (autoDrivingTimer.milliseconds()<600) {
                        moveStrafeLeft();
